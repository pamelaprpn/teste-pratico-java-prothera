...
public class Principal {
	...
	public static void main(String[] args) {
        ...
        for (Funcionario funcionario : funcionarios) {
            ...
            System.out.println("Data de nascimento: " + funcionario.getDataNascimento().format(formatterData));
          
            System.out.println("Salário: " + formatterNumero.format(funcionario.getSalario()));
        ...
        for (Funcionario funcionario : funcionarios) {
            funcionario.setSalario(
                funcionario.getSalario().multiply(new BigDecimal("1.10").setScale(2, RoundingMode.HALF_UP))
            );
        }
        ...
        System.out.println("-----------------------------");
        System.out.println("Total dos salários: " + formatterNumero.format(totalSalarios));
        ...
        for (Funcionario funcionario : funcionarios) {
        	...
        	System.out.println(funcionario.getNome() + ": " + quantidadeSalarios + " salários mínimos");
        }
